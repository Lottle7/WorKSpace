...
def do_tasks(embs, display=True):
    ...
    population_count_label = np.load("./data_Chi/population_counts.npy")

    population_mae, population_rmse, population_r2 = predict_regression(embs, population_count_label, display=display)
    return population_mae, population_rmse, population_r2


if __name__ == "__main__":
    embs = np.load("/data6/luyisha/guozitao/RegionMoE-demo/best_emb_population.npy")
    population_mae, population_rmse, population_r2 = do_tasks(embs, display=True)
    print(population_mae, population_rmse, population_r2)