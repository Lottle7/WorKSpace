...
### 模型加载
model_path = "./model/Llama-3.2-11B-Vision-Instruct"
...
### 读取数据
json_file = "./mmdata_Chi/prompt_data.json"
...
if task == "crime":
    ...
    task_prompt = "You are a top urban planner, population geographer and remote sensing analysis expert. Your task is to deeply analyze the multimodal data of a city area to accurately infer the actual population size, density and dynamic characteristics of the area.\n[Input Information]\nGiven are three types of information:\n1. Satellite images: Decode the residential capacity of the area from a macro perspective. Focus on:\n- Building types and distribution: Are they mainly low-density single-family homes, townhouses, or mid-to-high density apartment buildings? Is the building layout a regular grid or scattered and disorderly?\n- Land use intensity: Is the building coverage rate (the proportion of the building's projected area to the total area) high or low? Are there large areas of non-residential land (such as factories, parks)?\n- Area functions: Is it a clear residential area, commercial area, industrial area, or a mixed-function area?\n2. Street view images: Search for direct and indirect evidence of human residence and activities from a micro perspective. Focus on:\n- Residence confirmation: Number of windows, whether balconies have clothes drying racks, density of air conditioning units, number of parking spaces and vehicle density.\n- Activity level: The visible number of pedestrians and bicycles on the street; the prosperity of commercial facilities (such as large supermarkets, dense street-facing shops suggesting a large population).\n- Maintenance status: The overall maintenance level of the area can indirectly reflect the economic activities and population stability of the community.\n3. Text information: Contains the latitude and longitude, address, and POI category information of the area.\n[Your Core Task]\nPlease conduct a step-by-step reasoning, like a census taker, to estimate the population carrying capacity of the area and assess its actual residential intensity. Your analysis should focus on 'How many people can be accommodated here?' and 'What signs indicate that people are living here?' \n【Please think and output according to the following structure】\n1. Macro assessment of residential capacity:\n- Based on satellite images, first determine the dominant residential building type in the area and preliminarily assess its theoretical population capacity (high, medium, low). For example: 'The satellite image shows a grid-like layout of mid-floor apartment buildings, with a theoretical population capacity of high.'\n2. Micro evidence analysis of human activities:\n- Based on street view images, look for actual residential evidence that supports or contradicts the macro assessment. List all observed signs of high/low population density (for example: 'Dense air conditioning units', 'Few pedestrians under street lights at night', 'Satellite parking spaces are saturated').\n3. Comprehensive assessment and feature extraction:\n- Finally, integrate all information to make a final judgment on the actual population density level of the area (extremely high, high, medium, low), and explain the core reasons. Emphasize how the different modalities of information mutually confirm each other.\n- Summarize a set of key feature labels that best represent the population size and density characteristics of the area (for example: #High-density apartment area #High floor area ratio #High activity signs #Pure residential area #Family vehicles are dense or #Low-density villa area #Large green space #Low building coverage ratio #Few activity signs #Mixed commercial and residential area #Large day and night population fluctuations ).\nPlease focus your thinking on the above structured analysis. Your final output should be this detailed analysis report."
### 推理
model.eval()
with torch.no_grad():
